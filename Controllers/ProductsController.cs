...
namespace assignment.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(AssignmnetContext context, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Upload([FromForm] IFormFile file, [FromForm] int productID)
        {
            ...
            var fileName = Guid.NewGuid().ToString() + Path.GetExtension(file.FileName ?? ".tmp");
